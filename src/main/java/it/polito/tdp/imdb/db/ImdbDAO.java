...
public class ImdbDAO {
	...
	public void getVertici(int year, Map<Integer, Director> idMap) {
		String sql = "SELECT DISTINCT d.id, d.first_name, d.last_name "
				...
				+ "AND md.movie_id = m.id AND m.year = ? "
				+ "ORDER BY d.id ASC";
	...
	public List<Adiacenza> getAdiacenze(int year, Map<Integer, Director> idMap){
